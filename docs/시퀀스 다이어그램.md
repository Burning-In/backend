...
sequenceDiagram
    ...
    RANK_REST-->>FE: {stocks:[{stockName, stockCode, currentPrice, oneYearMomentum, frogInPanScore}]}
    FE-)RANK_SSE: SSE /breakout-success/subscribe
    RANK_SSE--)FE: event: ranking-update · [{stockName, stockCode, currentPrice, oneYearMomentum, frogInPanScore}] (지속)
    ...
    FE->>INSIGHT: GET /insight/momentumScore
...
sequenceDiagram
    ...
    FE->>INSIGHT: GET /insight/momentumScore?at=
...
sequenceDiagram
    ...
    FE->>INSIGHT: GET /insight/momentumScore?at=now
...
sequenceDiagram
    ...
    FE->>INSIGHT: GET /insight/regime?at=now
    FE->>INSIGHT: GET /insight/momentumScore?at=recordedAt
    FE->>INSIGHT: GET /insight/momentumScore?at=now
